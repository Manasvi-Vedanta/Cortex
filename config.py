...
# Set LLM_PROVIDER in .env to "gemini" or "openai"
# ===========================================
...
OPENAI_MODEL = os.getenv("OPENAI_MODEL", "gpt-5.2-2025-12-11")  # Options: gpt-4o, gpt-4o-mini, gpt-4-turbo, gpt-3.5-turbo
